...
echo $OWN_IP >> ~\RobustML\MusimyIP.txt
...
sshpass -p osboxes.org ssh osboxes@192.168.0.6 ping $OWN_IP -c 3 -q && echo -e "\e[32m192.168.0.6 OK\e[39m "
sshpass -p osboxes.org ssh osboxes@192.168.0.7 ping $OWN_IP -c 3 -q && echo -e "\e[32m192.168.0.7 OK\e[39m "
